...
class Game(ndb.Model):
    ...
    game_type = ndb.StringProperty(required=False, choices=['Random Map', 'Turbo Random Map', 'Regicide', 'Death Match', 'King of the Hill', 'Wonder Race', 'Defend the Wonder', 'Capture the Relic', 'Sudden Death'])
